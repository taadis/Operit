...
object MCPRepositoryConstants {
    ...
    object OfficialMCPConstants {
        ...
        object OfficialServerLogos {
            ...
            val LOGO_MAP =
                    mapOf(
                            ...
                            "Sequential Thinking" to "$BASE_GITHUB_LOGO/sequential-thinking.png",
                            "Slack" to
                                    "https://a.slack-edge.com/80588/marketing/img/icons/icon_slack_hash_colored.png",
                            "Sqlite" to "https://www.sqlite.org/images/sqlite370_banner.gif",
                            ...
                            "Aiven" to "https://aiven.io/images/site/aiven-logo-white.png",
                            ...
                            "Chargebee" to "https://chargebee.com/img/icons/chargebee-icon.svg",
                            ...
                            "Financial Datasets" to "$BASE_GITHUB_LOGO/financial-datasets.png",
                            ...
                            "Grafana" to "https://grafana.com/static/img/menu/grafana2.svg",
                            ...
                            "Integration App" to "$BASE_GITHUB_LOGO/integration-app.png",
                            "JetBrains" to
                            ...
                            "Langfuse Prompt Management" to "https://www.langfuse.com/favicon.ico",
                            ...
                            "MCP Toolbox for Databases" to "$BASE_GITHUB_LOGO/mcp-toolbox.png",
                            ...
                            "MotherDuck" to "https://motherduck.com/images/logo-stacked-red.svg",
                            ...
                            "Pinecone Assistant" to
                                    "https://images.prismic.io/pinecone-site/e1bd2016-7a5f-4b2b-88af-0fa3d316b1d1_pinecone-favicon-compression.svg?auto=compress,format",
                            "Prisma" to "https://prismalens.vercel.app/header/prisma-logo.svg",
                            ...
                            "LangChain" to "https://python.langchain.com/img/favicon.ico",
                            "MongoDB" to "https://www.mongodb.com/assets/images/global/favicon.ico",
                            ...
                            "Cloudflare Workers" to "https://workers.cloudflare.com/favicon.ico",
                            "Digital Ocean" to "https://www.digitalocean.com/favicon.ico",
                            ...
                            "CockroachDB" to "https://www.cockroachlabs.com/favicon.ico",
                            ...
                            "Solr" to "https://solr.apache.org/assets/images/favicon.ico"
                    )
            ...
            /**
             * Attempts to extract a domain name from a service name For example, "GitHub" would
             * return "github.com"
             */
            private fun extractDomainName(serverName: String): String {
                ...
                return when {
                    ...
                    cleanName == "postgresql" || cleanName == "postgres" -> "postgresql.org"
            ...
            private fun guessDomain(name: String): String {
                ...
                val dbKeywords =
                        listOf("db", "data", "base", "sql", "graph", "vector", "search", "store")
                val aiKeywords =
                        listOf(
                                "ai",
                                "ml",
        ...
        object OfficialServers {
            ...
            fun getEssentialOfficialServers(): List<MCPServer> {
            ...
            /** 添加参考服务器 */
            private fun addReferenceServers(servers: MutableList<MCPServer>) {
            ...
            /** 添加官方集成服务器 */
            private fun addOfficialIntegrationServers(servers: MutableList<MCPServer>) {
            ...
            private fun addServer(
                ...
                // 检查是否已存在相同ID的服务器，或者是否包含'discord'
                val id =
                        if (servers.any { it.id == idBase } || name.lowercase().contains("discord")
                        ) {
