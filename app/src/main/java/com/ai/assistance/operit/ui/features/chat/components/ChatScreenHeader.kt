...
fun ChatScreenHeader(
        ...
        val showModelSelector by
                apiPreferences.showModelSelectorFlow.collectAsState(initial = false)
        ...
        val configMapping by
                functionalConfigManager.functionConfigMappingFlow.collectAsState(
                        initial = emptyMap()
                )
        ...
        Box(
                                ...
                                IconButton(
                                        ...
                                        Icon(
                                                ...
                                                contentDescription =
                                                        if (isEditMode.value)
                                                                stringResource(
                                                                        R.string.exit_edit_mode
                                                                )
                                                        else
                                                                stringResource(
                                                                        R.string.enter_edit_mode
                                                                ),
                                                tint =
                                                        if (isEditMode.value)
                ...
                Row(
                        ...
                        // 使用一个状态来跟踪是否显示详细信息
                        val (showDetailedStats, setShowDetailedStats) =
