...
open class StandardFileSystemTools(protected val context: Context) {
        ...
        open suspend fun applyFile(tool: AITool): ToolResult {
                ...
                return try {
                                ...
                                if (writeResult.success) {
                                        ...
                                        val operationData =
                                                FileOperationData(
                                                        ...
                                                        successful = true,
                                                        details =
                                                                "Successfully created new file with AI code: $path"
                                                )
                        ...
                        val bindingResult =
                                enhancedAIService.applyFileBinding(originalContent, aiGeneratedCode)
                        ...
                        return ToolResult(
                                ...
                                result =
                                        FileOperationData(
                                                ...
                                                successful = false,
                                                details =
                                                        "Error applying file binding: ${e.message}"
                                        ),
