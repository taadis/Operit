...
fun TermuxWizardCard(
    ...
    Surface(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            // 进度和状态
            val isComplete = isTermuxInstalled && isTermuxAuthorized && isTermuxRunning &&
                    isTermuxBatteryOptimizationExempted && isTunaSourceEnabled && 
                    isPythonInstalled && isUvInstalled && isNodeInstalled
                ...
                when {
                    ...
                    !isTermuxRunning -> {
                        Column {
                            ...
                            Text(
                                text = "请点击「启动Termux」按钮打开Termux应用，并等待它完成初始化。初始化完成后，Termux会在后台保持运行，您可以继续进行配置操作。",
                                style = MaterialTheme.typography.bodySmall,
                    ...
                    !isComplete -> {
                        ...
                        val (title, description, buttonText, action) = when {
                            !isTermuxBatteryOptimizationExempted -> Quadruple(
                                "设置电池优化豁免",
