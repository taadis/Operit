...
fun PhoneLayout(
        ...
        // 阴影大小动画
        val sidebarElevation by animateDpAsState(
        ...
        // 仅在相关数据变化时更新抽屉内容
        LaunchedEffect(navItems, currentScreen, selectedItem, isNetworkAvailable, networkType) {
                cachedDrawerContent = {
                        DrawerContent(
                                navItems = navItems,
                        ...
                        modifier = Modifier
                                ...
                                .layout { measurable, constraints ->
                                        ...
                                        layout(placeable.width, placeable.height) {
                                                placeable.placeRelative(animatedOffset.roundToPx(), 0)
                                        }
                                }
                ) {
