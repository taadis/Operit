 ...
 * Pair<TAG, Stream<String>> and provides convenient methods to access the tag and stream.
 *
 ...
 */
class StreamGroup<TAG>(val tag: TAG, val stream: Stream<String>) {
    /**
...
fun <TAG> Pair<TAG, Stream<String>>.asStreamGroup(): StreamGroup<TAG> = StreamGroup(first, second)
