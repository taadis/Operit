                ...
                LazyColumn(
                        ...
                        modifier =
                                Modifier.weight(1f)
                                        ...
                                        // Only set transparent background when we actually have a background image
                                        .background(if (hasBackgroundImage) Color.Transparent else Color.Transparent)
                ) {
                        items(
