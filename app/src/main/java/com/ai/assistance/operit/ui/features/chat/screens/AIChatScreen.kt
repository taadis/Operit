                                ...
                                Card(
                                    ...
                                    Column(modifier = Modifier.padding(16.dp).fillMaxWidth()) {
                                        ...
                                        OutlinedTextField(
                                                ...
                                                onValueChange = {
                                                    editingMessageContent.value = it
                                                },
                                            ...
                                            Button(
                                                    onClick = {
                                                        ...
                                                        if (index != null &&
                                                            ...
                                                            viewModel.rewindAndResendMessage(
                                                                    index,
                                                                    editingMessageContent.value
                                                            )
                    ...
                    Box(modifier = Modifier.fillMaxSize()) {
                        ...
                        Box(
                                modifier =
                                        Modifier.fillMaxSize()
                                                .clickable { viewModel.toggleChatHistorySelector() }
                        ...
                        Box(
                            ...
                            ChatHistorySelector(
                                    ...
                                    chatHistories =
                                            chatHistories.sortedByDescending { it.createdAt },
