...
async function testClickElement(results) {
    try {
        ...
        if (targetElement) {
            ...
            const afterClickData = afterClickResult;
 ...
 */
async function testLaunchApp(results) {
    try {
        console.log("\nTesting launch_app...");
...
async function testCombinedOperation(results) {
    try {
        ...
        // Validate the result
        const combinedTapData = combinedTapResult;
        ...
        // Validate the result
        const combinedSwipeData = combinedSwipeResult;
        ...
        if (clickableId) {
            ...
            const combinedClickData = combinedClickResult;
