...
const baiduMap = (function () {
        ...
        try {
            ...
            for (let i = 0; i < Math.min(3, aoiKeywords.length); i++) {
                ...
                try {
                    ...
                    console.log(`✓ AOI搜索 "${keyword}" 成功，找到 ${((_a = aoiResult.aois) === null || _a === void 0 ? void 0 : _a.length) || 0} 条结果`);
                    // 如果找到了AOI结果，尝试获取边界
                ...
                for (let i = 0; i < testPlaces.length; i++) {
                    ...
                    try {
                        ...
                        if (aoi.success) {
                            ...
                            console.log(`  名称: ${((_b = aoi.aoi_info) === null || _b === void 0 ? void 0 : _b.name) || '未知'}`);
                            console.log(`  地址: ${((_c = aoi.aoi_info) === null || _c === void 0 ? void 0 : _c.address) || '未知'}`);
                            console.log(`  城市编码: ${aoi.city_code}`);
                            console.log(`  边界点数: ${((_e = (_d = aoi.aoi_info) === null || _d === void 0 ? void 0 : _d.boundary) === null || _e === void 0 ? void 0 : _e.length) || 0}`);
                        }
                        else {
    ...
    return {
        ...
        // 添加城市编码获取功能
        getCityCode: async (cityNameOrParams) => {
            let city_name;
