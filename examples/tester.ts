...
// Note: Types are defined in 'types/index.d.ts' and available globally

// Additional interfaces for the test functions
interface FindElementResultData {
    matchCount: number;
    matches: SimplifiedUINode[];
}
...
// Additional interfaces for new tests
...
async function runTests(params: { testType?: string } = {}): Promise<void> {
    ...
    try {
        ...
        if (results["get_page_info"]?.success) {
 ...
 */
async function testUIToString(results: { [key: string]: any }): Promise<void> {
    try {
        console.log("\nTesting UIPageResultData.toString()...");
        const pageInfo = await toolCall("get_page_info");

        // Type assertion and toString test
        const uiPageData = pageInfo as UIPageResultData;
 ...
 */
async function testFilesToString(results: { [key: string]: any }): Promise<void> {
    try {
 ...
 */
async function testHTTPToString(results: { [key: string]: any }): Promise<void> {
    try {
        ...
        // Type assertion and toString test
        const responseData = httpResponse as HttpResponseData;
 ...
 */
async function testSystemToString(results: { [key: string]: any }): Promise<void> {
    try {
 ...
 * Test UI page info
 */
async function testUIPageInfo(results: { [key: string]: any }): Promise<void> {
    try {
        ...
        if (uiPageData.uiElements) {
            ...
            console.log(`Child count: ${uiPageData.uiElements.children?.length || 0}`);
            ...
            const textInputs: SimplifiedUINode[] = [];

            function findTextInputs(node: SimplifiedUINode): void {
                if (!node) return;
 ...
 */
async function testCombinedOperation(results: { [key: string]: any }): Promise<void> {
    try {
        ...
        // Type assertion
        const combinedData = combinedResult as CombinedOperationResultData;
 ...
 * Test find element
 */
async function testFindElement(results: { [key: string]: any }): Promise<void> {
    try {
        ...
        // Type assertion
        const findElementData = findElementResult as FindElementResultData;
 ...
 * Test list files
 */
async function testListFiles(results: { [key: string]: any }): Promise<void> {
    try {
        console.log("\nTesting list_files...");
        const filesList = await toolCall("list_files", { path: "/sdcard/" });
 ...
 * Test read file
 */
async function testReadFile(results: { [key: string]: any }): Promise<void> {
    try {
        console.log("\nTesting read_file...");
        ...
        const fileData = fileContent as unknown as FileContentData;
 ...
 * Test file exists
 */
async function testFileExists(results: { [key: string]: any }): Promise<void> {
    try {
        console.log("\nTesting file_exists...");
        ...
        // Type assertion - use unknown as intermediate type to avoid linter error
        const fileExistsData = fileExistsResult as unknown as FileExistsData;
 ...
 * Test HTTP request
 */
async function testHTTPRequest(results: { [key: string]: any }): Promise<void> {
    try {
        ...
        // Type assertion
        const postResponseData = postResponse as HttpResponseData;
 ...
 * Test web search
 */
async function testWebSearch(results: { [key: string]: any }): Promise<void> {
    try {
        console.log("\nTesting web_search...");
        const searchResults = await toolCall("web_search", { query: "Android UI automation" });

        // Type assertion
        const searchData = searchResults as WebSearchResultData;
 ...
 * Test system setting
 */
async function testSystemSetting(results: { [key: string]: any }): Promise<void> {
    try {
 ...
 * Test list apps
 */
async function testListApps(results: { [key: string]: any }): Promise<void> {
    try {
        ...
        // Type assertion
        const appsData = appsResult as AppListData;
 ...
 * Test device info
 */
async function testDeviceInfo(results: { [key: string]: any }): Promise<void> {
    try {
        console.log("\nTesting get_device_info...");
        const deviceInfoResult = await toolCall("get_device_info");

        // Type assertion
        const deviceData = deviceInfoResult as DeviceInfoData;
 ...
 * Test clipboard operations
 */
async function testClipboard(results: { [key: string]: any }): Promise<void> {
    try {
        console.log("\nTesting clipboard operations...");
        ...
        // Type assertion
        const clipboardData = getClipboardResult as ClipboardData;
 ...
 */
async function runSingleTest(params: { testType: string }): Promise<void> {
 ...
 * Run toString tests
 */
async function testToString(): Promise<void> {
 ...
 * Run clipboard tests
 */
async function testClipboardOnly(): Promise<void> {
...
exports.testCalculator = function (): Promise<void> {
    return runTests({ testType: "calculator" });
};
exports.testConnection = function (): Promise<void> {
    return runTests({ testType: "connection" });
};
exports.testPackage = function (): Promise<void> {
...
async function testUIOperations(results: { [key: string]: any }): Promise<void> {
    try {
        ...
        // Type assertion
        const clickData = clickResult as UIActionResultData;
        ...
        // Type assertion
        const setTextData = setText as UIActionResultData;
        ...
        // Type assertion
        const keyPressData = keyPress as UIActionResultData;
...
async function testWriteFile(results: { [key: string]: any }): Promise<void> {
    try {
        console.log("\nTesting write_file...");
...
async function testFileOperations(results: { [key: string]: any }): Promise<void> {
    try {
...
async function testFindFiles(results: { [key: string]: any }): Promise<void> {
    try {
        console.log("\nTesting find_files...");
...
async function testFetchWebPage(results: { [key: string]: any }): Promise<void> {
    try {
        ...
        console.log("\nContent preview:");
        console.log(pageData.textContent?.substring(0, 200) + "...");
...
async function testSleep(results: { [key: string]: any }): Promise<void> {
    try {
        console.log("\nTesting sleep...");
...
async function testAppOperations(results: { [key: string]: any }): Promise<void> {
    try {
...
async function testCalculator(results: { [key: string]: any }): Promise<void> {
    try {
        console.log("\nTesting calculate...");
...
async function testDateCalc(results: { [key: string]: any }): Promise<void> {
    try {
        console.log("\nTesting date_calc...");
        ...
        // Type assertion
        const dateData = dateResult as DateResultData;
...
async function testCalculatorToString(results: { [key: string]: any }): Promise<void> {
    try {
...
async function testUsePackage(results: { [key: string]: any }): Promise<void> {
    try {
        console.log("\nTesting use_package...");
...
async function testQueryProblemLibrary(results: { [key: string]: any }): Promise<void> {
    try {
